...
class DETRHead(BaseModule):
    ...
    def loss_by_feat_single(self, cls_scores: Tensor, bbox_preds: Tensor,
        ...
        loss_cls, ind = self.loss_cls(
            cls_scores, labels, label_weights, avg_factor=cls_avg_factor, pos = num_total_pos)
        ...
        loss_iou = self.loss_iou(
            bboxes, bboxes_gt, bbox_weights, avg_factor=num_total_pos, ind=ind)

        # regression L1 loss
        loss_bbox = self.loss_bbox(
            bbox_preds, bbox_targets, bbox_weights, avg_factor=num_total_pos, ind=ind)
