...
def add_ubteacher_config(cfg):
    ...
    _C.SEMISUPNET.BURN_UP_WITH_STRONG_AUG = True # 是否在 burn up 阶段一并将强 data 丢入进行训练
    _C.SEMISUPNET.WEAK_AUG = False
    ...
    _C.SEMISUPNET.EVAL_TEACHER = True

    _C.SEMISUPNET.HAS_MULTI_LABEL = False
