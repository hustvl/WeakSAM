...
# The Configs can be directly changed into Instance Drop ones. losses in this section can be ignored.
class FastRCNNFocaltLossOutputLayers(FastRCNNOutputLayers):
    def __init__(self, cfg, input_shape, box2box_transform=None):
        super(FastRCNNFocaltLossOutputLayers, self).__init__(cfg, input_shape)
        self.num_classes = cfg.MODEL.ROI_HEADS.NUM_CLASSES
        if box2box_transform is not None:
