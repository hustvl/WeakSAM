...
def build_semisup_batch_data_loader_two_crop(
    ...
    *,
    ...
    # 相近 Aspect Ratio 的图片会放在一起, 从而避免了过于严重的 padding 操作
    if aspect_ratio_grouping:
        # 分别构建有标签数据集的 dataloader 以及无标签数据集的 dataloader
        ...
        # 用 AspectRatioGroupedSemiSupDatasetTwoCrop 封装
