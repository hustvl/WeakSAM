...
class RPN(nn.Module):
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret = {
            ...
            'reg_thresh': cfg.MODEL.INSTANCE_DROP.RPN_DROP
        }
    ...
    def forward(
        ...
        if self.training:
            ...
            losses = self.losses(
                anchors, pred_objectness_logits, gt_labels, pred_anchor_deltas, gt_boxes, instance_drop
            )
        else:
            losses = {}
