...
_C.MODEL.REGNETS = CN()
_C.MODEL.REGNETS.stem_width = 32
_C.MODEL.REGNETS.DEPTH = 22
_C.MODEL.REGNETS.W_A = 31.41
_C.MODEL.REGNETS.W_0 = 96
_C.MODEL.REGNETS.W_M = 2.24
_C.MODEL.REGNETS.GROUP_WIDTH = 64
_C.MODEL.REGNETS.NORM = "FrozenBN"
_C.MODEL.REGNETS.OUT_FEATURES = ["s1", "s2", "s3", "s4"]
_C.MODEL.REGNETS.SE_RATIO = 0.25
