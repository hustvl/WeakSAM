...
# class DropinsTrainer(DefaultTrainer):
#     def __init__(self, cfg):
#         """
#         Args:
#             cfg (CfgNode):
...
### Edited
    def run_step(self):
        ...
        ####
        if self.iter >= self.cfg.MODEL.INSTANCE_DROP.OPERATE_ITER and self.cfg.MODEL.INSTANCE_DROP.ISON:
            self._trainer.instance_drop = True
        ####
