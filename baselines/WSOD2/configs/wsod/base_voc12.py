...
data = dict(
    ...
    train=dict(
        ...
        proposal_file = 'WeakSAM/roi_generation/segment-anything/peak_proposal/VOC12/voc12trainval.pkl',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'VOC2012/ImageSets/Main/test.txt',
        img_prefix=data_root + 'VOC2012/',
        proposal_file = 'WeakSAM/roi_generation/segment-anything/peak_proposal/VOC12/voc12test.pkl',
