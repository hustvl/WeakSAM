...
JSON_FILE_PATH = "/data/zhulianghui/yingyueli/Mask2Former/datasets/VOC2012/voc_2012_train_aug_cocostyle_wsss.json"
OUTPUT_ROOT_PATH = "/data/zhulianghui/yingyueli/Mask2Former/cim-visualization/pgt"

MetadataCatalog.get("voc12_trainaug_coco").set(thing_classes=CLASS_NAMES)
voc_metadata = MetadataCatalog.get("voc12_trainaug_coco")
# 获取数据集字典
...
for d in dataset_dicts:  # 随机选择三张图片进行展示
    # if "2007_009756" not in d["file_name"]:
    #     continue
    # print(d["file_name"])
    # break
